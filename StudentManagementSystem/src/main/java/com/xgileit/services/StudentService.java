...
import com.xgileit.repositories.StudentRepository;
...
public class StudentService {
    ...
    public String submitStudentDetails(Student student)
    {
       ...
       try {
           ...
           else if (student.getStudentId() == null || student.getName() == null || student.getSurname() == null || student.getCellNumber() == null) {
